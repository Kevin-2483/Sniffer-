...
set_target_properties(PcapPlusPlus::Pcap++ PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/pcapplusplus"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:ws2_32>;\$<LINK_ONLY:iphlpapi>;Packet::Packet;PcapPlusPlus::Common++;PcapPlusPlus::Packet++;\$<\$<BOOL:OFF>:PF_RING::PF_RING>;\$<\$<BOOL:OFF>:DPDK::DPDK>;PCAP::PCAP;Threads::Threads"
)
