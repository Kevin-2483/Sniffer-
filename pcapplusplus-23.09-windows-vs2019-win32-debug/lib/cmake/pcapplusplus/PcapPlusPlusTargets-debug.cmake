...
set_target_properties(PcapPlusPlus::Packet++ PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/Packet++.lib"
  )
...
set_target_properties(PcapPlusPlus::Pcap++ PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/Pcap++.lib"
  )
...
set_target_properties(PcapPlusPlus::Common++ PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/Common++.lib"
  )
...
set_target_properties(PcapPlusPlus::Arping PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/Arping.exe"
  )
...
set_target_properties(PcapPlusPlus::ArpSpoofing PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/ArpSpoofing.exe"
  )
...
set_target_properties(PcapPlusPlus::DNSResolver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/DNSResolver.exe"
  )
...
set_target_properties(PcapPlusPlus::DnsSpoofing PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/DnsSpoofing.exe"
  )
...
set_target_properties(PcapPlusPlus::HttpAnalyzer PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/HttpAnalyzer.exe"
  )
...
set_target_properties(PcapPlusPlus::IcmpFileTransfer-catcher PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/IcmpFileTransfer-catcher.exe"
  )
...
set_target_properties(PcapPlusPlus::IcmpFileTransfer-pitcher PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/IcmpFileTransfer-pitcher.exe"
  )
...
set_target_properties(PcapPlusPlus::IPDefragUtil PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/IPDefragUtil.exe"
  )
...
set_target_properties(PcapPlusPlus::IPFragUtil PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/IPFragUtil.exe"
  )
...
# Import target "PcapPlusPlus::benchmark" for configuration "Debug"
set_property(TARGET PcapPlusPlus::benchmark APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(PcapPlusPlus::benchmark PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/benchmark.exe"
  )
...
set_target_properties(PcapPlusPlus::PcapPrinter PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/PcapPrinter.exe"
  )
...
set_target_properties(PcapPlusPlus::PcapSearch PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/PcapSearch.exe"
  )
...
set_target_properties(PcapPlusPlus::PcapSplitter PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/PcapSplitter.exe"
  )
...
set_target_properties(PcapPlusPlus::SSLAnalyzer PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/SSLAnalyzer.exe"
  )
...
set_target_properties(PcapPlusPlus::TcpReassembly PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/TcpReassembly.exe"
  )
...
set_target_properties(PcapPlusPlus::TLSFingerprinting PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/TLSFingerprinting.exe"
  )
